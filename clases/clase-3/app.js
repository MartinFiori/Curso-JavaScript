"use strict"
        ...
        button.addEventListener('click', ()=>{
            let largo = prompt("Ingrese con qué medida de longitud desea trabajar\nPor ej: cm, m, km, etc...");
        ...
        while(figura != 5){
            ...
            switch(figura){
                ...
                case 4:
                    ...
                    height = parseInt(prompt("Ingrese la longitud de la altura"))
                    result = (base*height)
                    alert(`El área del rectángulo es de ${result}${largo}.`)
                    break
